...
const Store = () => {
  ...
  useEffect(() => {
    const newCategory = productState.map((element) => element.category);
    setCategorie([...new Set(newCategory)]);
  }, [productState]);
              ...
              <div>
                <ul className="ps-0">
                  {categories.map((item, index) => (
                    <li className="py-2" key={index} onClick={() => setCategory(item)}>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-10">
                  ...
                  <select className="form-control form-select" onChange={(e) => setSort(e.target.value)}>
                    ...
                    <option value="-price">Prix dé​​croissant</option>
